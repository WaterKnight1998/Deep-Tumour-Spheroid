            ...
            if (form.file.files.length > 0) {
                ...
                ajax.onload = function () {
                    ...
                    if (ajax.status >= 200 && ajax.status < 400) {
                        ...
                        data.forEach((elem) => {
                            const prediction = `
                            <div class="d-flex flex-row position-relative justify-content-around my-4 flex-wrap border border-primary border-3 p-3 rounded">
                                ...
                                <div class="d-flex flex-column align-items-center"> 
                                    <img class="img-fluid" height="500" width="500" src="data:image/png;base64,${elem.image}"/>
                                    <div class="text-primary font-weight-bold">${elem.filename}</div>
                                </div>
                                <div class="d-flex flex-column align-items-center"> 
                                    <img class="img-fluid" height="500" width="500" src="data:image/png;base64,${elem.mask[0].mask_data}"/>
                                    <div class="text-primary font-weight-bold">${elem.mask[0].model_name}</div>
                                </div>
                            </div>
                        `;
